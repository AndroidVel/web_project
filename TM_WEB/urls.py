...
from .views import home, audio_to_image, image_to_audio, audio_from_image, audio_insert_in_image, process_image_feed, add_image_feed, delete_image
...
urlpatterns = [
    path('', home, name='home'),
    path('audio_to_image/', audio_to_image, name='register'),
